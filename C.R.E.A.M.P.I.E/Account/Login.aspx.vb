...
Partial Public Class Login
    ...
    Protected Sub initAdmin()
        ...
        con = New SqlConnection("Data Source=(LocalDb)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\CREAMPIECentralDB.mdf;Initial Catalog=CREAMPIECentralDB;Integrated Security=True")

        Dim cmdstring As String
        cmdstring = "INSERT INTO Employee (Username,Password,Auth_Level,FName,LName,Cellnumber) VALUES ('admin@creampie.co.za','" & Encrypt.GenerateHash("password") & "',1,'Admin','Admin',1234567890"
    ...
    Protected Sub LogIn(sender As Object, e As EventArgs)
        If IsValid Then
            ...
            Connection = New SqlConnection("Data Source=(LocalDb)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\CREAMPIECentralDB.mdf;Initial Catalog=CREAMPIECentralDB;Integrated Security=True")

            Dim CommandString As String

            CommandString = "SELECT * FROM Employee WHERE Username ='" & TempUsername & "';"
