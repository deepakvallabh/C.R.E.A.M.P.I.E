<%@ Page Title="Manage Users" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ManageUsers.aspx.vb" Inherits="C.R.E.A.M.P.I.E.ManageUsers" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="table" style="width: 100%">
                 ...
                 <div id="display" runat="server">
                     <asp:GridView ID="GridView1" runat="server" Visible="False" CellPadding="5" ForeColor="#333333" GridLines="None" HorizontalAlign="Center" CellSpacing="1" PageSize="15">
                          ...
                          <Columns>
                            ...
                            DataNavigateUrlFormatString="~\Management\ViewUser.aspx?ID={0}" />
                    </Columns>
        ...
        <div class="container" style="width:50%; margin:auto, 0">
            ...
            <div class="col-sm-6">
            <asp:LinkButton ID="btnAddUser" runat="server" OnClick="AddUser" Text="Add User" CssClass="btn btn-default btn-lg"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add User</asp:LinkButton>
            </div>
            <div class="col-sm-6">
